...
const R: Record<string, ShotVoice> = {
  ...
  rev_2: {
    ...
    tease:
      "The robe doesn't slip unless Liora lets it. She let it — one caramel shoulder, gold moon still catching the light. What's under the silk is black lace. That's Shot 3.",
    grant: "The robe slipped for you. Not for a room.",
    story:
      "A moving robe is her stalling, and she knows it. Black lace is underneath. That's Shot 3.",
  ...
  rev_4: {
    ...
    story: "Sitting down is how she closes the door. Shot 5 is eye contact — the this-is-for-you frame.",
  ...
  rev_5: {
    ...
    tease:
      "This is the look Liora withholds. Moon at her throat, eyes on you, no performance. If you felt picked, that's the point. Shot 6 she lets the robe breathe — six seconds, not a still.",
    grant: "She's looking at you. Not a room. Not a feed.",
    story: "Eye contact is rarer than lace. Motion is rarer than that. Shot 6 is six seconds she will not reshoot.",
  ...
  rev_6: {
    ...
    tease:
      "Six seconds. Liora lets the cream robe move on purpose. You don't get this as a photo. You get it as a breath — then Shot 7, the last polite layer.",
    grant: "You have the clip. Watch it. She did this once.",
    story: "You can pause a photo. You can't pause this. After the clip, polite clothing is over.",
  ...
  rev_7: {
    ...
    story: "The slip was a costume. Shot 8 is the nude with no performance. Shot 9 is the frontal close.",
  ...
  rev_8: {
    ...
    tease:
      "Sheet. Skin. Liora stopped performing. This is the private set — full nude, no robe left to hide behind. The last unlock is the close, and she caps how many men get it.",
...
const C: Record<string, ShotVoice> = {
  crv_1: {
    ...
    story: "The face was a courtesy. The rest of this set is the curve. Shot 2 is the drape down a caramel spine.",
    drop: "",
  },
  crv_2: {
    visual: "Cream silk pooled at the small of her back. Spine. Shoulder blades. Delay.",
    tease:
      "Silk on Liora's back is a delay tactic. She uses it well — spine, shoulder blades, the line still covered. Shot 3 is from the small of her back down.",
  ...
  crv_3: {
    ...
    story: "Hips. The study starts here. Shot 4 she holds longer for men who don't rush the close.",
  ...
  crv_4: {
    ...
    tease:
      "She holds the turn longer for men who stay. That's not generosity. That's Liora testing whether you can stay on the back without demanding the close. Shot 5 is gold light.",
    grant: "She's holding still for you.",
    story: "A held pose is the upgrade. Shot 5 is rim light on the worship — the study frame men save.",
  ...
  crv_6: {
    ...
    tease:
      "Cropped. No face. Liora doesn't need to look at you anymore. That's when it gets honest — and Shot 7, side-lying, unposed, is rarer than an arch.",
  ...
  crv_7: {
    ...
    tease:
      "Side-lying. Liora's curve without the pose. Unposed is rarer than arched — that's why it costs more, and why Shot 8 is the frame men screenshot.",
    grant: "She's not posing anymore. Shot 8 is the frame men save.",
    story: "Unposed is intimacy. Shot 8 is the offered frame. Shot 9 is the close-up with nothing left to drape.",
  ...
  crv_8: {
    ...
    tease:
      "This is the frame men screenshot. Liora knows. The last unlock is the close — full worship, no robe, no delay, the hips she will not reshoot.",
    grant: "You have the offered pose. One close-up left.",
    story: "Offered is still a pose. Shot 9 is the last close-up of the curve. She caps it at 48.",
  ...
  crv_9: {
    ...
    story: "You didn't buy an ass shot. You finished a strip she designed so stopping would feel stupid.",
...
const P: Record<string, ShotVoice> = {
  ped_1: {
    ...
    tease:
      "Liora crossed her ankles and waited. Nude heel, red sole, gold anklet catching the lamp. This set always starts at the shoes. Shot 2 she recrosses them — that's her noticing you stayed on the floor.",
  ...
  ped_2: {
    ...
    story: "The recross is her noticing you. Shot 3 is the extend. A test. Don't flinch.",
  ...
  ped_4: {
    ...
    tease:
      "Gold on Liora's ankle. She only wears it for the private set. Shoes come off next. That's the real set — heels were a costume.",
    grant: "The anklet is yours. Shoes come off next.",
    story: "Jewelry is a private-set signal. Shot 5 is shoes off. Everything before this was a costume.",
    drop: "61% never see the anklet. They left while she still had shoes on.",
  },
  ped_5: {
    visual: "Bare sole. No heel. Soft light. The real hunger.",
    tease:
      "Shoes off. Bare sole. This is the real set. Liora's heels were a costume. Bare is the hunger you actually paid to confess — Shot 6 she holds the foot still for you.",
    grant: "Shoes off. The heels were a costume.",
    story: "Bare is the admission. Shot 6 she holds the foot in frame. No fidgeting. For you.",
  ...
  ped_6: {
    ...
    tease:
      "She holds the foot in frame. No fidgeting. For you. The next unlock is Liora's soles — the shot the other collectors climbed the floor for.",
    grant: "She's holding still. Don't blink.",
    story: "Held still is her side of the ritual. Shot 7 is soles. That's why men are on this set.",
  ...
  ped_8: {
    ...
    tease:
      "Close. Soft. No performance. Liora let you look this long. The last unlock is the full pedestal — arch, sole, gold anklet, held.",
    grant: "You have the study. She let you look this long.",
    story: "This is her letting you look. Shot 9 is the last close-up. She doesn't reshoot an inspection.",
...
export const PHOTOSETS: Record<string, PhotosetVoice> = {
  ...
  lad_curve: {
    ...
    tease:
      "The Curve is the set Liora shoots when she won't face you yet. Over the shoulder first. Then silk on a caramel spine. Then hips, cropped, honest. Unposed is rarer than arched. The last close is the worship the climb was built to make you buy.",
    shots: C,
  },
  lad_pedestal: {
